...
//    titleLabel.text = @"DiZoo";
    ...
    UILabel *subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 60, 280, 40)];
    subtitleLabel.text = @"Terminos y Condiciones";
    
    UITextView *licAgreementTextView = [[UITextView alloc] initWithFrame:CGRectMake(20,100,340,300)];
